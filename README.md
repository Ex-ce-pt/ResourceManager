...
<tbody>
    ...
    <tr>
        ...
        <td>An <i>equal</i> operator, return value is determined comparing resources' names, sizes, pointers to the data and UUIDs.</td>
    </tr>
    <tr>
...
<tbody>
    ...
    <tr>
        ...
        <td>Load a resource using a resource name.
            ...
            Args:
            <ul>
    		    <li><code>name</code> - the name of the resource (corresponds to the path to the file in the original folder)</li>
            </ul>
    		Returns:
            <ul>
    ...
    <tr>
        ...
        <td>Load a resource using a resource name.
    		...
    		Args:
            <ul>
    		    <li><code>name</code> - the name of the resource (corresponds to the path to the file in the original folder, C string)</li>
            </ul>
    		Returns:
            <ul>
    		    <li>Loading success</li>
    ...
    <tr>
        ...
        <td>Release the resource thus freeing the memory.
    		...
    		Args:
            <ul>
    		    <li><code>name</code> - the name of the resource to release.</li>
            </ul>
    ...
    <tr>
        ...
        <td>Release the resource thus freeing the memory.
    		...
    		Args:
    		<ul>
                <li><code>res</code> - the resource to release.</li>
            </ul>
    		<b>N.B. - Make sure that there's no shared pointers of the resource before calling!</b>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>Get a loaded resource.
    		...
    		Args:
            <ul>
    		    <li><code>entryName</code> - the name of a loaded resource.</li>
            </ul>
    		Returns:
            <ul>
    ...
    <tr>
        ...
        <td>Get a loaded resource.
    		...
    		Args:
            <ul>
    		    <li><code>entryName</code> - the name of a loaded resource (C string).</li>
            </ul>
    		Returns:
            <ul>
    		    <li>A weak pointer to the resource.</li>
    ...
    <tr>
        ...
        <td>Set a path to a resouce file.
    		...
    		Args:
            <ul>
    		    <li><code>path</code> - a path to a  resource file.</li>
            </ul>
        </td>
    </tr>
    <tr>
        ...
        <td>Set a path to a resouce file.
    		...
    		Args:
            <ul>
    		    <li><code>path</code> - a path to a resource file (C string).</li>
            </ul>
        </td>
    </tr>
    <tr>
...
<h2><u>Experimental Features</u></h2>

<hr>

<h3>WResource class</h3>
<p><b>WResource</b> class is exactly the same as the <b>Resource</b> class, but it uses <i>wide characters</i> to represent the name of the resource and its attributes.</p>
...
<tbody>
    ...
    <tr>
        <td><code>WResource()</code></td>
        <td>A default constructor.</td>
    </tr>
    <tr>
        <td><code>WResource(const WResource& other)</code></td>
        <td>A copy constructor that accepts an lvalue refference.</td>
    </tr>
    <tr>
        <td><code>WResource(WResource&& other) noexcept</code></td>
        <td>A copy constructor that accepts an rvalue refference.</td>
    </tr>
    <tr>
        <td><code>void operator=(const WResource& other)</code></td>
        <td>An assignment operator for lvalue refferences.</td>
    </tr>
    <tr>
        <td><code>void operator=(WResource&& other) noexcept</code></td>
        <td>An assignment operator for rvalue refferences.</td>
    </tr>
    <tr>
        <td><code>bool operator==(const WResource& other) const</code></td>
        <td>An <i>equal</i> operator, return value is determined comparing resources' names, sizes, pointers to the data and UUIDs.</td>
    </tr>
    <tr>
        <td><code>WResource copy() noexcept</code></td>
        <td>A function returning a copy of the resource it has been called on (the data gets copied as well).</td>
    </tr>
    <tr>
        <td><code>void* getPtr() const</code></td>
    ...
    <tr>
        <td><code>std::wstring getName() const</code></td>
        <td>Returns the resource's name (is equal to the name of the file this resource was created of).</td>
    </tr>
    <tr>
        <td><code>const wchar_t* getNameRaw() const</code></td>
        <td>Returns the resource's name as a C string (see <code>std::wstring getName() const</code>).</td>
    </tr>
    <tr>
        <td><code>const std::unordered_map&lt;std::wstring, std::wstring&gt;& getAttributes() const</code></td>
        <td>Returns the resource's attributes.</td>
    </tr>
    <tr>
        <td><code>const UUID& getUUID() const</code></td>
...
<h2>WResourceSaver class</h2>
<p><b>WResourceSaver</b> class is exactly the same as <b>ResourceSaver</b> class, but it uses <code>std::filesystem::path</code> type (wide strings) to represent the input and output file path</p>

<table>
<tbody>
    <tr>
        <td><code>static void storeAsResources(const std::filesystem::path& folderPath, const std::filesystem::path& output, const std::unordered_map&lt;std::wstring, std::unordered_map&lt;std::wstring, std::wstring&gt;&gt;& attributes = {})</code></td>
        <td>Stores a folder of files as a resource file.
            <br>
            Args:
            <ul>
...
<h2>WResourceLoader class</h2>
<p><b>WResourceLoader</b> class is exactly the same as <b>ResourceLoader</b> class, but it uses wide character types.</p>
...
<tbody>
    ...
    <tr>
        <td><code>WeakResourcePtr</code></td>
        <td><code>std::weak_ptr&lt;WResource&gt;</code</td>
    </tr>
    <tr>
        <td><code>ResourcePtr</code></td>
        <td><code>std::shared_ptr&lt;WResource&gt;</code</td>
    </tr>
    <tr>
        <td><code>ResourceMap</code></td>
        <td><code>std::unordered_map&lt;UUID, WResourcePtr&gt;</code</td>
    </tr>
    <tr>
        <td><code>ResourceSignature</code></td>
        <td><code>std::tuple&lt;std::wstring, size_t, long&gt;</code</td>
    </tr>
</tbody>
</table>
...
<tbody>
    ...
    <tr>
        <td><code>WResourceLoader()</code></td>
        <td>A default constructor.</td>
    </tr>
    <tr>
        <td><code>WResourceLoader(const std::wstring& path)</code></td>
        <td>A constructor that sets the path.</td>
    </tr>
    <tr>
        <td><code>WResourceLoader(const std::filesystem::path& path)</code></td>
        <td>A constructor that sets the path (accepts <code>std::filesystem::path</code> object).</td>
    </tr>
    <tr>
        <td><code>WResourceLoader(const wchar_t* path)</code></td>
        <td>A constructor that sets the path (accepts C string).</td>
    </tr>
    <tr>
        <td><code>void scanFile()</code></td>
    ...
    <tr>
        <td><code>bool loadResource(const std::wstring& name)</code></td>
        <td>Load a resource using a resource name.
            <br>
            Args:
            <ul>
    		    <li><code>ame</code> - the name of the resource (corresponds to the path to the file in the original folder)</li>
            </ul>
    		Returns:
            <ul>
    		    <li>Loading success</li>
    ...
    <tr>
        <td><code>bool loadResource(const wchar_t* name)</code></td>
        <td>Load a resource using a resource name.
            <br>
    		Args:
            <ul>
    ...
    <tr>
        <td><code>void releaseResource(const std::wstring& name)</code></td>
        <td>Release the resource thus freeing the memory.
            <br>
    		Args:
            <ul>
    ...
    <tr>
        <td><code>void releaseResource(const wchar_t* name)</code></td>
        <td>Release the resource thus freeing the memory.
            <br>
    		Args:
            <ul>
    ...
    <tr>
        <td><code>WeakResourcePtr getResource(const std::wstring&  resourceName)</code></td>
        <td>Get a loaded resource.
            <br>
    		Args:
            <ul>
    ...
    <tr>
        <td><code>WeakResourcePtr getResource(const wchar_t* resourceName)</code></td>
        <td>Get a loaded resource.
            <br>
    		Args:
            <ul>
    ...
    <tr>
        <td><code>void setPath(const std::wstring& path)</code></td>
        <td>Set a path to a resouce file.
            <br>
    		Args:
            <ul>
    ...
    <tr>
        <td><code>void setPath(const wchar_t* path)</code></td>
        <td>Set a path to a resouce file.
            <br>
    		Args:
            <ul>
    ...
    <tr>
        <td><code>std::wstring getPath() const</code></td>
        <td>Get the path to the current resouce file.
            <br>
    		Returns:
            <ul>
    		    <li>The path in <code>std::wstring</code> class</li>
            </ul>
        </td>
    </tr>
    <tr>
        <td><code>const wchar_t* getPathRaw() const</code></td>
        <td>Get the path to the current resouce file.
            <br>
    		Returns:
            <ul>
